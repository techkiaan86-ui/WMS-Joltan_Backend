...
const Product = sequelize.define('Product', {
  ...
  vatRate: { type: DataTypes.DECIMAL(5, 2), defaultValue: 20.00, allowNull: true },
  vatCode: { type: DataTypes.STRING, defaultValue: 'STANDARD', allowNull: true },
  ...
  indexes: [
    ...
    { name: 'idx_products_sku_client', unique: true, fields: ['company_id', 'client_id', 'sku'] },
  ],
});
