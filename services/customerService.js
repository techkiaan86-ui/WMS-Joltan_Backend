...
async function create(data, reqUser) {
  ...
  return Customer.create({
    ...
    isClient: data.isClient !== undefined ? Boolean(data.isClient) : true,
...
async function update(id, data, reqUser) {
  ...
  const updates = {
    ...
    isClient: data.isClient !== undefined ? Boolean(data.isClient) : customer.isClient,
